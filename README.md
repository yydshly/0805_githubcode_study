...
| [小红书 AI 工作台研究站](./xiaohongshu-ai-workbench-study/) | 第 10 个项目 · 策划层演示可用 | 拆解 7 个 Codex Skills 如何把运营方法封装为策划模板；用当前研究库演示主页、母题、日历、标题、评论和路径，并明确其不产出完整笔记、图片、发布或数据复盘 | [项目说明](./xiaohongshu-ai-workbench-study/README.md) · [在线研究站](https://yydshly.github.io/0805_githubcode_study/xiaohongshu-ai-workbench-study/) · [上游仓库](https://github.com/nihe0909/xiaohongshu-ai-workbench) |
